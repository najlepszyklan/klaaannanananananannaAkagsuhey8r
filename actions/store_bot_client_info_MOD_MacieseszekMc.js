...
<div style="float: left; width: 80%;">
	...
	<select id="info" class="round">
		<option value="0" selected>Bot Description</option>
	</select>
</div>
<div>
...
action: function(cache) {
    const description = this.getDBM(this.description);
	if(!bot) {
